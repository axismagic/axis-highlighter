...
!(function($) {
  ...
  function getMenu($this) {
    ...
    if (selectedText != null && selectedText.length > 0) {
      $(".create-ref").removeClass("disabled-link");
    } else {
      $(".create-ref").addClass("disabled-link");
    }

    // var key = $menu.closest("span.highlight").attr("ref");
    // if (key != null && key.length > 0) {
    //   $(".remove-ref").removeClass("disabled-link");
    // } else {
    //   $(".remove-ref").addClass("disabled-link");
    // }
